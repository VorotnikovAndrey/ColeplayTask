...
namespace PlayVibe
{
    public sealed class PopupService
    {
        ...
        public async UniTask<AbstractBasePopup> ShowPopup(PopupOptions popupOptions, Action hideAction = null)
        {
            ...
            var popup = await objectPoolService.GetOrCreateView<AbstractBasePopup>(popupOptions.PopupKey,PopupsCanvas.GetCanvasTransform(popupOptions.PopupGroup));
            ...
            var lastPopupInGroup = Popups[popupOptions.PopupGroup].LastOrDefault();
            var sortingOrder = lastPopupInGroup != null
                ? lastPopupInGroup.Canvas.sortingOrder + 1
                : canvas.sortingOrder + Popups[popupOptions.PopupGroup].Count + 1;
            ...
            await UniTask.WhenAny(popup.Show(popupOptions.Data, () =>
                {
                ...
                popupOptions.Force), UniTask.WaitUntil(() => popup == null));
